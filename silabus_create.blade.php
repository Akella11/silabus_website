...
<head>
    ...
    <title>Створення силабуса</title>
</head>
<style>
...
<div class="flex-container3">
    ...
    <form class="form2" method="post" action="dataInsert">
        @csrf
        <input type = "text" class="input1" placeholder="Введіть рівень вищої освіти" name="degree">
        <input type = "text" class="input2" placeholder="Введіть галузь знань" name="branch">
        <input type = "text" class="input3" placeholder="Введіть спеціальність" name="specialty">
        <input type = "text" class="input4" placeholder="Введіть освітню програму" name="program">
        <input type = "text" class="input5" placeholder="Введіть статус дисципліни" name="status">
        <input type = "text" class="input6" placeholder="Введіть форму навчання" name="form">
        <input type = "text" class="input7" placeholder="Введіть рік підготовки" name="year">
        <input type = "text" class="input8" placeholder="Введіть обсяг дисципліни" name="amount">
        <input type = "text" class="input9" placeholder="Введіть семестровий контроль" name="exams">
        <input type = "text" class="input10" placeholder="Введіть розклад занять" name="schedule">
        <input type = "text" class="input11" placeholder="Введіть мову викладання" name="language">
        <input type = "text" class="input12" placeholder="Введіть викладачів" name="professors">
        <input type = "text" class="input13" placeholder="Введіть розміщення курсу" name="placement">
        <button class="submit1">Створити</button>
    </form>
</div>
<p class="p5">Програма навчальної дисципліни</p>
<div class="flex-container4">
    <form class="form3" method="post" action="dataInsert2">
        @csrf
